          ...
          >
            ...
            <nav className="overlay-vertical-menu">
              ...
              <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}>
                <Link to="/booking" className="overlay-nav-item" onClick={() => setHeroMenuOpen(false)}>
                  {isRtl ? "الاستديو" : "Studio"}
                </Link>
              </motion.div>

              <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.16 }}>
                <Link to="/printing-products" className="overlay-nav-item" onClick={() => setHeroMenuOpen(false)}>
