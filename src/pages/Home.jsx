...
import { Camera, GraduationCap, Printer, MapPin, MessageSquare, ArrowLeft } from "lucide-react";
import HeroBloomScene from "../components/premium/HeroBloomScene";
...
const WaveDivider = ({ color = '#ffffff', flip = false }) => (
  <div className={`wave-divider ${flip ? 'wave-flip' : ''}`}>
    <svg viewBox="0 0 1440 100" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M0,40 C360,100 720,0 1080,60 C1260,80 1380,30 1440,50 L1440,100 L0,100 Z" fill={color} />
    </svg>
  </div>
);
...
const Home = () => {
  ...
  // Skip preloader on internal page navigation if it already ran in memory
    ...
    <>
      ...
      {preloaderDone && (
        <main className="home-page" dir="rtl">
          {/* 1. Rebuilt GSAP Pinned Scroll Hero Bloom Scene */}
          <HeroBloomScene />

          <div className="white-content-page">
                ...
                >
                  <motion.div variants={cardVariant}>
                    <Link to="/booking" className="service-card-simple">
                      <div className="service-icon-wrapper">
                        <Camera className="service-icon" size={42} strokeWidth={1.5} />
                      </div>
                  ...
                  <motion.div variants={cardVariant}>
                    <Link to="/graduation-books" className="service-card-simple">
                      <div className="service-icon-wrapper">
                        <GraduationCap className="service-icon" size={42} strokeWidth={1.5} />
                      </div>
                  ...
                  <motion.div variants={cardVariant}>
                    <Link to="/printing-products" className="service-card-simple">
                      <div className="service-icon-wrapper">
                        <Printer className="service-icon" size={42} strokeWidth={1.5} />
                      </div>
            ...
            <section className="home-portfolio-section">
              <div className="section-container">
                ...
                {portfolio.length > 0 ? (
                  ...
                  >
                    {portfolio.map((item) => (
                      <motion.div key={item.id} className="home-portfolio-card" variants={cardVariant}>
            ...
            {/* Wave divider */}
            <WaveDivider color="var(--color-bg-light)" />
