...
const TemplatesGallery = () => {
  ...
  return (
    <main className="grad-page" dir="rtl">
      {/* Hero */}
      <section className="grad-hero" style={{ padding: '56px 24px 44px' }}>
        <div className="grad-hero-badge">📁 المعرض</div>
        <h1>قوالب دفاتر التخرج</h1>
        <p>استعرض جميع قوالب الغلاف الخارجي، الورق الداخلي، وورق الإهداء</p>
      </section>

      {/* Section A: Cover Templates */}
      <section className="grad-section" style={{ paddingBottom: 24, paddingTop: 48 }}>
        <h2 className="grad-section-title">أ. قوالب الغلاف الخارجي</h2>
      ...
      <section className="grad-section" style={{ paddingBottom: 48, paddingTop: 24 }}>
        <h2 className="grad-section-title">ب. قوالب الورق الداخلي والإهداء</h2>
        <div className="grad-section-line" style={{ margin: '0 auto 32px' }} />
