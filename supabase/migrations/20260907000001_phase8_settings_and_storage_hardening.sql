...
-- ------------------------------------------------------------
-- 1. SITE SETTINGS: expose only keys intentionally used by the
--    public website. Admins retain full access through is_admin().
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 2. Storage buckets: enforce coarse upload limits and MIME types
--    at bucket configuration level, complementing object RLS.
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 3. Customer-upload object policies: constrain allowed path shape
--    without changing the current application paths.
-- ------------------------------------------------------------
